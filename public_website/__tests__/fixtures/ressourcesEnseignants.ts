export const RessourcesEnseignatsPageFixtures = {
  ressourcesEnseignant: {
    ...
    attributes: {
      ...
      seo: {
        id: 1,
        metaTitle: 'Aide enseignants Ressources',
        metaDescription:
          'enseignants Ressources description description description description',
        ...
        metaViewport: 'width=device-width, initial-scale=3',
        canonicalURL:
        ...
        metaSocial: [
          {
            ...
            title: 'Aide enseignants enseignants Ressources',
            description: 'Aide enseignants Ressources enseignants Ressources',
            image: {
              data: {
                id: 36,
                attributes: {
                  ...
                  formats: {
                    ...
                    thumbnail: {
                      ...
                      mime: 'image/jpeg',
                      name: 'thumbnail_miqcrosoft-365-kTFmwxkF5bQ-unsplash.jpg',
                      path: null,
                      size: 4.29,
                      width: 104,
                      height: 156,
                  ...
                  hash: 'micryosoft_365_k_T_Fmwxk_F5b_Q_unsplash_b376f7bd44',
                  ext: '.jpg',
                  mime: 'image/jpeg',
                  size: 1777.47,
