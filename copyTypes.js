...
const destinationFolder = "public_website/src/types";

const files = [
  {
    src: path.join(
      __dirname,
      "./content_management_system/types/generated/contentTypes.d.ts"
    ),
  ...
  },
  {
    src: path.join(
      __dirname,
      "./content_management_system/types/generated/components.d.ts"
    ),
